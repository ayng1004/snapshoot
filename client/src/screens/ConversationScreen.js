...
const ConversationScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    if (!chatId) {
      console.log("ID de conversation manquant, retour à l'écran de chat");
      navigation.replace('Chat'); // Remplacez par le nom correct de votre écran de chat
      return;
    }
    
    // Configurer la navigation si chatId est défini
    if (chatName) {
